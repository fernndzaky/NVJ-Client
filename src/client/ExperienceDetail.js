      ...
      <div className="">
        ...
        <div className='row'>
            <div className='col-12 ps-0 pe-0' style={{textAlign:'center'}}>
                <p className='px-36' style={{color:'#333333',fontFamily:'Nunito Bold',marginBottom:'8vw',marginTop:'4vw'}}>Teras Nepal</p>
                {/* START OF TOP CAROUSEL */}
                <div id="banner_carousel" className="carousel slide ps-0 pe-0" data-ride="carousel">
        ...
        <div className='row page-container' style={{marginTop:'12vw'}}>
        ...
        <div className='row upper-page-padding-small page-container'>
            <div className='col-12 p-0'>
                <p className='px-36' style={{color:'#333333',fontFamily:'Nunito Bold',marginBottom:'5vw',whiteSpace:'pre-line'}}>Other On-Site Experiences</p>
            </div>
            ...
            <div style={{marginTop:'6vw',padding:'0'}}>
                <a href="/" className='px-18 btn-grey' style={{fontFamily:'Roboto Bold',textDecoration:'none',display:'inline-block',width:'100%'}}>View All On-Site List</a>
            </div>
        </div>
